...
%6-6 changed eps to eps1. No numerical issue, but eps1 is a better
%practice in MATLAB. eps is not protected but rather unsafe to use in MATLAB. I also adjusted parameters in particular, rw=0.3. 
...
f=@(t,P)[r*P(1).*(1- (P(1)+P(2))/K) - game*P(1).*P(3) - gami*P(1).*P(2) - rho*P(1).*P(4); ...
         ...
         eps1*P(2) - mue*P(3); ...
         alpha*(rho*P(1).*P(4) + omega*rho*P(2).*P(4))+rw*P(4).*(1-P(4)/Kw)];
