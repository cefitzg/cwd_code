...
%Used to make Figure 8 in "The effect of predation on the dynamics of
%Chronic Wasting Disease in deer" 

% in this file we calculate the probability of disease elimination 
...
WRlist =  [0: 0.05:1];  %these are the values used for the deterministic model
...
c(1) = b;  %s->s+1
R =  A0/(Kp*A); %needs to be Kp not K edit 5-21. 
c(2) = d; %s->s-1
...
%  xlabel('t (years)','fontsize',20)
%  ylabel('s, i','fontsize',20)
%    title( strcat('\rho_iW = ',sprintf(formatSpecF,rhoiW)),'fontsize',18)
% axis([0 t_end 0 K*A/A0])
% 
% phase portrait
 % figure(4*(nr-1)+3)
